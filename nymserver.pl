...
# Debian: libdb-file-lock-perl
use DB_File;
use Socket;
use Fcntl ':flock';
# Debian: libio-all-perl
use IO::Handle;
use IO::Select;
...
# Debian: libdigest-md5-file-perl
...
my $HOMEDIR = '/var/local/crypt/home/cpunk';
my $HOSTNAME = 'nym.mixmin.net';
my $SENDMAIL = '/usr/sbin/sendmail';
my $QMAIL_CODES = 0; # Use qmail rather than sendmail exit codes
my $REMAIL = '/var/local/crypt/home/cpunk/Mix/mixmaster -SR';
...
Or this GnuPG command:
 gpg -sear config\@$HOSTNAME -u $nym\@$HOSTNAME renew
